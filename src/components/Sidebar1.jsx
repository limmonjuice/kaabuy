            ...
            <nav className="py-4 overflow-y-auto h-[calc(100vh-80px)]">
                ...
                <div className="mb-6">
                    ...
                    <button
                        ...
                        className={`flex items-center ${isOpen ? 'px-6 mx-4' : 'px-3 mx-2 justify-center'} py-3 rounded-lg transition-all duration-300 ease-in-out text-gray-600 hover:bg-red-50 hover:text-red-600 w-auto`}
                        title={!isOpen ? 'Logout' : ''}
                    >
                        <span className={`${isOpen ? 'mr-3' : ''}`}>
                            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
