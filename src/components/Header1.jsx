        ...
        <header className="bg-white dark:bg-gray-900 shadow-sm border-b border-gray-200 dark:border-gray-700 transition-colors duration-200">
            <div className="flex items-center justify-between px-6 py-3">
                ...
                <div className="flex items-center space-x-4">
                    <img src={isDarkMode ? darkLogo : logo} alt="Kaabuy Logo" className="h-12 w-auto object-contain transition-all duration-300" />
                    <div className="h-8 w-px bg-gray-300 dark:bg-gray-600"></div>
                    <div className="flex items-center">
                        <span className="text-lg font-semibold text-gray-900 dark:text-white">{user?.storeName || 'Store Name'}</span>
                        <span className="text-lg font-semibold text-orange-500 ml-2">Control Center</span>
                    </div>
                </div>
                    ...
                    {user && (
                        <div className="relative">
                            <button
                                ...
                                className="flex items-center space-x-3 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-lg px-2 py-1 transition-colors duration-200"
                            >
                                {/* Avatar */}
                                ...
                                <div className="hidden md:block text-left">
                                    ...
                                    <p className="text-xs text-gray-500 dark:text-gray-400">{user.role || 'Store Owner'}</p>
                                </div>
                            </button>
